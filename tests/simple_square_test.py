#!/usr/bin/env python3
"""
Simple Monte Carlo test for average distance in a unit square.
...
def main():
    ...
    print(f"Simple Monte Carlo Test: {n_samples:,} samples")
    print("=" * 50)
    ...
    for i in range(n_samples):
        p1 = sample_unit_square()
        p2 = sample_unit_square()
    ...
    # Print results
    print(f"Average distance between random points: {average_distance:.6f}")
