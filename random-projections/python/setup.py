#!/usr/bin/env python3
"""
Build script for projection Python bindings.

This script builds the C++ extension module for the projection library
...
setup(
    name="projection",
    version=VERSION,
    description="Projection calculations library",
    ...
    ext_modules=[
        CMakeExtension("projection._core"),
    ],
    cmdclass={
